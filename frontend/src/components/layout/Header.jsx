...
import { Flag, User, Menu } from 'lucide-react';
            ...
            <div className='flex items-center justify-between h-full px-6'>
                ...
                <div className='flex items-center gap-3'>
                    ...
                    <button className='relative inline-flex items-center justify-center w-10 h-10 text-slate-600 hover:text-slate-900 hover:bg-slate-100 rounded-xl transition-all duration-200 group'>
                        <Flag size={20} strokeWidth={2} className='group-hover:scale-110 transition-transform duration-200' />
                    ...
                    <div className='flex items-center gap-3 pl-3 border-l border-slate-200/60'>
                        <div className='flex items-center gap-3 px-3 py-1.5 rounded-xl hover:bg-slate-50 transition-colors duration-200 cursor-pointer group'>
                            <div className='w-9 h-9 rounded-xl bg-linear-to-br from-purple-400 to-fuchsia-400 flex items-center justify-center text-white shadow-md shadow-purple-500/20 group-hover:shadow-lg group-hover:shadow-purple-500/30 transition-all duration-200'>
